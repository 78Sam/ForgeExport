...
mkdir /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/pcap
mkdir /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/server-output
mkdir /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/hydra-output
docker network create -d bridge --subnet 172.18.0.0/16 main
docker run --name server -v /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/server-output:/capture-results --ip 172.18.0.5 --network=main -itd forge/apache-ssh
docker run --name server-tcpdump -v /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/pcap:/data/pcap --network=container:server -itd forge/tcpdump
...
docker run --name siege-tcpdump -v /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/pcap:/data/pcap --network=container:siege -itd forge/tcpdump
...
docker run --name nmap-hydra -v /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/hydra-output:/capture-results --ip 172.18.0.10 --network=main -itd forge/hydra-nmap
docker run --name nmap-hydra-tcpdump -v /home/sam/Documents/Dissertation/ForgeExport/scenarios/scenario-ssh-bruteforce/data/pcap:/data/pcap --network=container:nmap-hydra -itd forge/tcpdump
