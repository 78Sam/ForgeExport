...
mkdir /Users/sammccormack/Documents/Uni/Year4/Diss/ForgeExport/scenarios/scenario-stress/data/pcap
docker network create -d bridge --subnet 192.168.0.0/24 main
docker run --name nginx -v /Users/sammccormack/Documents/Uni/Year4/Diss/ForgeExport/scenarios/scenario-stress/environment:/usr/share/nginx/html -p 8080:80 --ip 192.168.0.5 --network=main -itd forge/nginx
docker run --name nginx-tcpdump -v /Users/sammccormack/Documents/Uni/Year4/Diss/ForgeExport/scenarios/scenario-stress/data/pcap:/data/pcap --network=container:nginx -itd forge/tcpdump
...
docker run --name siege-1-tcpdump -v /Users/sammccormack/Documents/Uni/Year4/Diss/ForgeExport/scenarios/scenario-stress/data/pcap:/data/pcap --network=container:siege-1 -itd forge/tcpdump
...
docker run --name siege-0-tcpdump -v /Users/sammccormack/Documents/Uni/Year4/Diss/ForgeExport/scenarios/scenario-stress/data/pcap:/data/pcap --network=container:siege-0 -itd forge/tcpdump
