...
class Manipulator:
    def __init__(self, logger: Logger, dataset_path=None, metadata_path=None, target_label=None,  original_df=None, metadata_manip=False):
    ...
    def numeric_columns(self, numeric_cols):
        ...
        for col in numeric_cols:
            print(f"[*] Turning {col} in {numeric_cols} to numeric")
    ...
    def string_columns(self, string_cols):
        ...
        for col in string_cols:
            try:
                ...
                self.logger.log(
                    message=f"Failed to find column {col} to convert values to strings",
                    type="error"
                )
