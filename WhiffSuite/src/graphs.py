...
def main() -> None:
    ...
    # m = Manipulator("/Users/sammccormack/Documents/Uni/Year4/Diss/Forge/captures/capture-alert/data/flows", metadata_path="/Users/sammccormack/Documents/Uni/Year4/Diss/Forge/captures/capture-alert/config.json", target_label="Attack", metadata_manip=False)
    m = Manipulator("/Users/sammccormack/Documents/Uni/Year4/Diss/Forge/captures/capture-alert/data/flows", metadata_path="/Users/sammccormack/Documents/Uni/Year4/Diss/Forge/WhiffSuite/tests/metadata/our_metadata.json", target_label="Attack", metadata_manip=False)
